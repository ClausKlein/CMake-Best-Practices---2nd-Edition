...
# We will utilize the ExternalProject module for satisfying the catch2
# dependency.
include(ExternalProject)

# Declare catch2 dependency details. We will explicitly require 2.13.9 version
# this time.
externalproject_add(
    catch2_download
...
# Since the include directory of the catch2 is not available at the configure
# stage (ExternalProject_Add retrieves and builds the dependency at build stage)
# we'll just go ahead and create the include directory, so we can list that
# directory in INTERFACE_INCLUDE_DIRECTORIES property of the catch2 target.
...
# Add CATCH2_INCLUDE_DIR to INTERFACE_INCLUDE_DIRECTORIES of the catch2 target,
